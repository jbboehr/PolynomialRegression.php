...
class PolynomialRegression
{
    ...
    /**
     * @var int The index of the current element.  Basiclly a count of data added.
     */
    private $index = 0;
    ...
    /**
     * X values reference (for comparison).
     *
     * @var mixed
     */
    private $xReferences = array();
    ...
    public function addData($x, $y)
    {
        ...
        $this->xReferences[strval($x)] = true;
    }
    ...
    public function getCoefficients($numberOfCoefficient = -1)
    {
        ...
        $coefficients = array_fill(0, $numberOfCoefficient, 0);

        if (count($this->xReferences) < $numberOfCoefficient) {
            $numberOfCoefficient = count($this->xReferences);
            if (1 === $numberOfCoefficient) {
                $coefficients[0] = bcdiv($this->xyPowers[0], $this->xPowers[0]);
     ...
     */
    public static function interpolate($coefficients, $x)
    {
